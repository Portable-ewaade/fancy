...
const Banner = () => {
  return (
    <div className="md:bg-[#03032F] bg-[#07075D]">
      <section className="grid_container 2xl:container mx-auto relative lg:h-[40rem] h-[65vh] mb-20">
        <main className="wrapper">
          <TrackVisibility>
            {({ isVisible }) => (
              ...
              >
                <div className=" text-white absolute md:top-1/3 top-1/4 lg-xl:start-20 md:start-32 start-4 md:mt-12 mt-5">
                  ...
                  <p className="md:text-xl text-sm font-bold tracking-wide mt-5 ">
                    ...
                    <br className="hidden md:block" /> us? Feel free to reach
                    out.
                  </p>
                </div>
              </div>
